...
const MENU = {
  cafes: {
    ...
    itens: [
      ...
      { nome: "Mocha",      preco: "R$ 15,00", img: "/image_mocha.png",                     desc: "Combinação perfeita de espresso, chocolate e leite vaporizado." },
      { nome: "Macchiato",  preco: "R$ 10,00", img: "/image_macchiato.png",                     desc: "Espresso marcado com uma pitada de espuma de leite." },
      { nome: "Flat White", preco: "R$ 13,00", img: "/image_flat_white.png",                     desc: "Espresso duplo com leite vaporizado sedoso e delicado." },
      { nome: "Affogato",   preco: "R$ 16,00", img: "/image_affogato.png",                     desc: "Sorvete de baunilha afogado em espresso quente." },
    ],
  },
  bebidas: {
    label: "Bebidas",
    ...
    itens: [
      { nome: "Suco de Laranja",    preco: "R$ 10,00", img: "image_suco_de_laranja.png", desc: "Suco natural espremido na hora, fresquinho." },
  ...
  salgados: {
    ...
    itens: [
      { nome: "Pão de Queijo Recheado", preco: "R$ 14,00", img: "/image_pao_queijo.png", desc: "Recheado com muçarela de búfala e tomate seco." },
  ...
  doces: {
    ...
    itens: [
      { nome: "Brownie com Nozes",    preco: "R$ 16,00", img: "/image_brownie.png", desc: "Feito com chocolate belga e nozes caramelizadas." },
      { nome: "Cheesecake de Frutas", preco: "R$ 18,00", img: "/image_cheesecake.png", desc: "Cremoso e leve, com calda de frutas vermelhas." },
  ...
  veganos: {
    ...
    itens: [
      { nome: "Açaí com Frutas",    preco: "R$ 16,00", img: "/image_acai.png", desc: "Açaí puro com frutas frescas e granola." },
      { nome: "Smoothie Verde",     preco: "R$ 14,00", img: "/image_smoothie", desc: "Espinafre, maçã verde, gengibre e limão." },
      { nome: "Muffin de Banana",   preco: "R$ 12,00", img: "/image_muffin_banana", desc: "Sem ovos, sem leite, cheio de sabor e carinho." },
    ],
  },
};
