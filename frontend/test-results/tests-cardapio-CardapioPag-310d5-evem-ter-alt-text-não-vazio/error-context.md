...
- Name: tests\cardapio.spec.js >> CardapioPage >> Acessibilidade >> todas as imagens com conteúdo devem ter alt text não vazio
- Location: tests\cardapio.spec.js:104:3
