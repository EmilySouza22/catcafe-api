...
test.describe('Navbar', () => {
  ...
  test('ícone do menu deve ter alt text', async ({ page }) => {
    const menuIcon = page.getByAltText('ícone de menu');
  ...
  for (const { label, path } of NAV_LINKS) {
    test(`link "${label}" deve ter classe ativa quando na rota ${path}`, async ({ page }) => {
  ...
  test('link ativo não deve ser aplicado a links de outras rotas', async ({ page }) => {
